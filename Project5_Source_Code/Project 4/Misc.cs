...
namespace Project_4
{
    class Misc
    {
        ...
        public static void Initialize_Chart(int Length, Chart TSP_Chart, Chart Graph_Data) 
        {
            ...
            Graph_Data.ChartAreas[0].AxisX.Title = "Solution";
            Graph_Data.ChartAreas[0].AxisX.Maximum = 10;
            Graph_Data.ChartAreas[0].AxisX.TitleForeColor = Color.White;
            Graph_Data.ChartAreas[0].AxisY.TitleForeColor = Color.White;
        }

        public static Dictionary<int, List<int>> addDictionary(Dictionary<int, List<int>> dict, Dictionary<int, List<int>> toAdd)
        {
